            ...
            <div className="sticky top-2 border text-[#545252] w-full h-full flex gap-7 flex-col justify-center items-center">
              ...
              <div className="sticky w-full h-full flex flex-col px-4 py-2 gap-5">
                <div className="flex flex-col text-[12px]  border-b  item-center   w-full cursor-pointer font-normal">
                  ...
                  >
                    <label class="h-[1.2rem] w-[4rem] relative block aspect-[2/0.75] cursor-pointer rounded-full  bg-gradient-to-r from-gray-200 to-gray-100 bg-[length:100%_100%] shadow-2xl shadow-purple-300 transition-all duration-500 [&amp;:has(input:checked)]:rotate-180  hover:bg-[length:100%_500%] focus:bg-[length:100%_500%] bg-blue-600">
